...
contra.finalvalue2 = permute(contra2.SI.peakR,[3 2 1]);
contra.stdofeachvalue2 = permute(contra2.SI.errorR,[3 2 1]);
...
ipsi.finalvalue2 = permute(ipsi2.SI.peakR,[3 2 1]);
ipsi.stdofeachvalue2 = permute(ipsi2.SI.errorR,[3 2 1]);
...
finalvalue=cat(3,contra.finalvalue2,ipsi.finalvalue2); %finalvalue size: ncells,nSteps,1,1
...
ODI_pref2=(contra.finalvalue2(pos)-ipsi.finalvalue2(pos))./(ipsi.finalvalue2(pos)+contra.finalvalue2(pos));
...
if filename
    ...
    for j=1:ncells-1
        ...
        errorbar(1:nSteps,contra.finalvalue2(j,:),contra.stdofeachvalue2(j,:),'r*-');
        errorbar(1:nSteps,ipsi.finalvalue2(j,:),ipsi.stdofeachvalue2(j,:),'b+-');
